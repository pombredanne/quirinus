...
#ifndef QUIRINUS_CORE_UNICODE_U32_DECODE_HPP
#define QUIRINUS_CORE_UNICODE_U32_DECODE_HPP
           ...
           size_t& offset)
{
  ...
  // Allocate memory.
  state = quirinus::u32_mbslen(encptr, enclen, declen, offset);
  if (!!state)
    return state;
...
#endif // QUIRINUS_CORE_UNICODE_U32_DECODE_HPP
