...
#ifndef QUIRINUS_CORE_UNICODE_U16_UCSLEN_HPP
#define QUIRINUS_CORE_UNICODE_U16_UCSLEN_HPP
namespace quirinus {
           ...
           size_t& offset)
{
  ...
  enclen += 2; // Byte order mark
  return UNICODE_STATE_SUCCESS;
}


} // namespace quirinus
#endif // QUIRINUS_CORE_UNICODE_U16_UCSLEN_HPP
